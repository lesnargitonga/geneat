...
HAZINA_COLLECTION_IMAGES: dict[str, str] = {
    ...
    "kenya-edit": "/treasures/kenya-edit-hero.webp",
    "highland-treasure": "/treasures/highland-treasure-hero.webp",
    "nomad-leather-set": "/treasures/nomad-leather-set-hero.webp",
    "safari-romance-box": "/treasures/safari-romance-box-hero.webp",
    "departure-drop": "/treasures/departure-drop-hero.webp",
}

HAZINA_TREASURE_IMAGES: dict[str, str] = {
    "premium-coffee-250g": "/treasures/coffee-beans-variety.webp",
    "loose-leaf-tea": "/treasures/premium-tea-spoons.webp",
    "raw-honey": "/treasures/raw-honey-jars.webp",
    "maasai-bracelet": "/treasures/beaded-bracelet.webp",
    "maasai-necklace": "/treasures/maasai-necklace-worn.webp",
    "maasai-earrings": "/treasures/maasai-earrings.webp",
    "leather-passport": "/treasures/leather-passport-open.webp",
    "leather-luggage-tag": "/treasures/leather-luggage-tag-lifestyle.webp",
    "soapstone-big-five": "/treasures/big-five-sculpture.webp",
    "antelope-carving": "/treasures/antelope-wood-carving.webp",
    "wood-carving-set": "/treasures/handmade-woodcarvings.webp",
    "lamu-keepsake-box": "/treasures/beaded-wood-containers.webp",
    "coastal-kikoi": "/treasures/african-woven-mats.webp",
    "mombasa-brass-scoop": "/treasures/premium-tea-spoons.webp",
    "swahili-drums": "/treasures/swahili-drums-set.webp",
    "rungu-clubs": "/treasures/wooden-clubs-beaded.webp",
    "woven-basket": "/treasures/basket-variety.webp",
    "sisal-basket-small": "/treasures/basket-weaving-hands.webp",
    "kitenge-fabric": "/treasures/kitenge-textiles.webp",
    "beaded-market-bag": "/treasures/beaded-market-bag.webp",
    "maasai-sandals": "/treasures/maasai-sandals.webp",
    "wooden-combs": "/treasures/wooden-combs.webp",
    "african-wall-art": "/treasures/african-art.webp",
    "sculpture-piece": "/treasures/africa-sculptures.webp",
    "kitenge-umbrella": "/treasures/kitenge-umbrellas.webp",
    "pottery-vessel": "/treasures/pottery-hands.webp",
    "big-five-print": "/treasures/big-five-art.webp",
    "maasai-market-tote": "/treasures/maasai-market-bags.webp",
    "african-woven-mat": "/treasures/african-woven-mats.webp",
    "african-hand-broom": "/treasures/african-hand-broom.webp",
    "beaded-wood-containers": "/treasures/beaded-wood-containers.webp",
    "coconut-shell-plates-spoons": "/treasures/coconut-shell-plates-spoons.webp",
    "premium-packaging": "/treasures/gift-box-light.webp",
}
...
def build_hazina_menu_photos(portal_base_url: str = "https://hazina.lesnarai.co.ke") -> dict[str, str]:
    ...
    out: dict[str, str] = {
        "menu": f"{base}/treasures/african-market-shop.webp",
        "collections": f"{base}/treasures/african-market-shop.webp",
        "safari": f"{base}/brand/safari-sunset.webp",
    }
    for row in HAZINA_COLLECTIONS:
