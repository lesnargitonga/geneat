...
def main() -> int:
    ...
    fixed: dict[str, str] = {
        ...
        "EXPECTED_RENDER_REGION": current.get("EXPECTED_RENDER_REGION", "frankfurt"),
        "DATABASE_REGION": current.get("DATABASE_REGION", "frankfurt"),
        "REDIS_REGION": current.get("REDIS_REGION", "frankfurt"),
