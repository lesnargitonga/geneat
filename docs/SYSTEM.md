...
| Spatial showroom UX | ✅ | ◐ | Hero composition, pointer response, controlled drag, restrained magnetic cursor, and controlled collection-vault reveal; live after the Render-watched branch rebuilds and smoke passes |
