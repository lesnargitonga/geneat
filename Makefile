...
check-contracts:
	...
	$(PYTHON) -m pytest -v tests/test_routing_contract.py tests/test_payload_contract.py tests/test_resilience_contract.py tests/test_resiliency_user_facing.py
